...
void playNote(NOTE note)
{
    if(note.freq != pause)
    {
        ...
        ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 &= ~(3 << 20); // Pulisce
        ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 |= (2 << 20); // Imposta AOUT
