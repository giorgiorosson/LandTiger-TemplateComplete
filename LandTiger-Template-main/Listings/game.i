...
void disegna_griglia_statica(void) {
    ...
    for(i = 0; i < height_px; i++) {
        LCD_SetPoint(x_start, y_start + i, 0xF81F // 0xF81F (T piece) - R=31, G=0, B=31);
...
void ADC_init(void) {
    ...
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 |= (3 << 30);
    ...
    ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADCR = (1 << 5) | // Seleziona il canale 5 (AD0.5)
...
void aggiorna_gioco(void) {
    ...
    while (!(((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADGDR & (1U << 31)));

    // 3. Leggi il risultato (Bit 4-15)
    int adc_val = (((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADGDR >> 4) & 0xFFF;
